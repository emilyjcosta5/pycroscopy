...
h5_path = r"/lustre/or-hydra/cades-birthright/29t/mpiDataBoi{}.h5".format(time.time())
copyfile(h5_og_path, h5_path)

#h5_og_path = r"C:/Users/Administrator/Dropbox/GIv Bayesian June 2019/pzt_nanocap_6_split_bayesian_compensation_R_correction (Alvin Tan's conflicted copy 2019-06-25).h5"
#h5_path = r"tempFatBoi.h5"
#copyfile(h5_og_path, h5_path)
